    ...
    <div class="logo-title">
      ...
      <div class="input">
        <div class="svg-input">
          ...
          >
            <path
              d="M80.115 8.324 0 45.356l19.96 75.96 15.265-1.897-4.245-47.69 5.058-2.258 8.58 48.774 25.923-3.162-4.607-52.657 4.878-2.167 9.483 53.65 26.284-3.251-5.058-57.715 4.967-2.168 10.387 58.618 25.922-3.161V24.04zM82.011 123.393l1.265 7.497 59.521 9.935v-24.838l-60.695 7.406z"
            ></path>
          </svg>
        </div>
        <input class="input-id" placeholder="Enter Riot ID, ie. player#NA1" />
      </div>
      ...
      <div class="searchbox__signin">
        ...
        <span class="sign-in_description">Sign in with Riot ID</span>
      </div>
    </div>
    ...
    <div class="section-container">
      <div class="checkpoint_intro">
        ...
        <p class="checkpoint_description">
          LoL and Traker news, updates and more
        </p>
      </div>
